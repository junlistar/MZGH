...
--220009挂号 新增用户信息弹窗
insert into mz_patient_mi(patient_id,social_no,hic_no,p_bar_code,name,sex,birthday,home_tel,addition_no1,employer_name,
...
(@patient_id,@social_no,@hic_no,@p_bar_code,@name,@sex,@birthday,@home_tel,@addition_no1,@employer_name,'0',0,0,0,0,
