...
namespace Data.Repository
{
    public class ReportDataFastRepository : RepositoryBase<ReportData>, IReportDataFastRepository
    {
        ...
        public DataTable GetMzghBill(string code, string patient_id, string times)
        {
            ...
            foreach (var item in paramlist)
            {
                ...
                {
                    sql = sql.Replace(":" + item.param_name, "'" + times + "'");
                }
            }
            return ExecuteTable(sql, null, CommandType.Text);
        }
        ...
        public ReportData GetReportDataByCode(string code)
        {
            ...
            string sql = GetSqlByTag("rt_reportdatafastnet_getbycode");
        ...
        { 
            string sql = GetSqlByTag("rt_reportdatafastnet_update_reportcom");
            var para = new DynamicParameters();
