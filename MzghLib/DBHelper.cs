...
namespace MyMzghLib
{
    public class DbHelper
    {
        ...
        /// 连接字符串
        /// </summary> 
       //public static readonly string connectionString = "Data Source = 10.102.41.147; Initial Catalog = his; User ID = sa; Password=gx@2019;";
       // public static readonly string connectionString = @"File Name =" + "C:\\Program Files\\Common Files\\System\\Ole DB\\Data links\\" + "chis.udl";
        public static readonly string connectionString = ConfigurationManager.AppSettings.Get("conn");
        ...
        /// <param name="values">参数数组</param>
        /// <returns>结果集DataTable</returns>
        public static DataTable ExecuteProc(string Sql, params SqlParameter[] values)
        {
            using (SqlConnection Connection = new SqlConnection(connectionString))
            {
                if (Connection.State != ConnectionState.Open)
